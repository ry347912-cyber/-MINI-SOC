...
### 🔍 IDS Monitor — Intrusion Detection
![IDS Monitor](monitor.png.png)

### 📡 Network Traffic — Live Packet Monitor
![Network Traffic](Network.png.png)

### 🦠 Malware Sandbox — Isolated Analysis
![Malware Sandbox](Malware%20snadbox.png.png)

### 📊 Analysis Results — Behavioral Reports
![Analysis Results](analysis.png.png)

### 🐳 Dockerfile
![Dockerfile](docker.png.png)

### 🐳 Docker Compose
![Docker Compose](dockercompose.png.png)

### 🚀 Start Script
![Start Script](start.png.png)
